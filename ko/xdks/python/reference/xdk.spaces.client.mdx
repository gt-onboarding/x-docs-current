...
Space 티켓 구매자 가져오기
특정 Space의 id를 사용해 해당 Space 티켓을 구매한 사용자 목록을 반환합니다.
...
지정된 User ID로 생성된 Spaces의 세부 정보를 조회합니다.
...
Space 게시물 가져오기
지정된 Space의 ID를 사용하여 해당 Space에서 공유된 게시물 목록을 가져옵니다.
...
<ParamField path="path.max_results" type="int or None" default="None">
지정한 Space에서 가져올 게시물 수입니다. 제공하지 않으면 기본적으로 최대 100개가 사용됩니다.
</ParamField>
