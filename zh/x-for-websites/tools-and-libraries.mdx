...
>
官方插件，可为你的 WordPress 站点优化对 X 的支持，包括帖子嵌入和 X 卡片。
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
>
X 提供的免费开源 emoji 字符集，其中包含用于跨平台支持的 JavaScript 库。
</Card>
</CardGroup>
...
以下工具由更广大的 Web 开发者社区提供和支持，并非官方资源。感谢社区做出的这些贡献！
...
由 [@MichaelDeBoey](https://github.com/MichaelDeBoey) 开发
</Card>
</CardGroup>
