...
Las conexiones de streaming se gestionan automáticamente con lógica de reintentos con backoff exponencial para un manejo robusto.
...
Elimina una suscripción para un evento de actividad en X
