...
keywords: ["news", "API de noticias", "titulares", "última hora", "consulta de noticias", "noticias", "búsqueda de noticias"]
---

El endpoint de consulta de noticias permite a los desarrolladores obtener noticias y titulares de última hora en X.

Este endpoint admite los métodos de autenticación app-auth y user-auth para OAuth1 y OAuth2 PKCE.

<div id="getting-started">
  ## Primeros pasos
</div>

Para usar este endpoint, necesitas un [Bearer Token](/es/fundamentals/authentication/oauth-2-0/application-only) del [portal para desarrolladores](https://developer.x.com/en/portal/dashboard).
