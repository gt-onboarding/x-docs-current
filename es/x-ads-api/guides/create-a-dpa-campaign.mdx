...
Realiza una llamada GET a la API accounts/:account&#95;id/funding&#95;instruments utilizando el id de la cuenta obtenido en el comando anterior.
...
<div id="step-2-create-line-item-with-sales-objective">
  ## Paso 2: Crear un line item con el objetivo de ventas
</div>

Crea un line item asociado con la campaña.
...
* Después de este paso, la campaña estará disponible en Ads Manager de X.
...
* La URL debe comenzar con [https://twitter.com](https://twitter.com); se puede añadir cualquier parámetro UTM adicional después, como en el siguiente ejemplo:
...
* Parámetros obligatorios: id de cuenta de anuncios, id de usuario, URI de la card (del paso 3), text, name y dynamic product ad
* dynamic&#95;product&#95;ad debe tener siempre el valor true
...
<div id="step-5-associate-post-with-line-item">
  ## Paso 5: Asociar la Publicación con la partida
</div>

Asocia la Publicación con la partida.

* Parámetros obligatorios: id de la cuenta de anuncios, id de la partida (del Paso 2) e id de la Publicación (id&#95;str del Paso 4)
...
Si los anunciantes quieren ver la tarjeta en la interfaz, también estará disponible ahí.
